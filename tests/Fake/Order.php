...
namespace DexiLandazel\PrimePayments\Test\Fake;
...
class Order extends Model
{
     ...
     * @return Order
     */
    public static function SearchOrderFilterPaidforPayOrderFromGate(Request $request, $order_id, $orderStatus = 'order_payed', $orderSum = '1', $orderCurrency = '1')
    {
        $order = new self([
            '_orderSum' =>  $orderSum,
     ...
     * @return Order
     */
    public static function SearchOrderFilterPaid(Request $request, $order_id, $orderStatus = 'order_payed', $orderSum = '12345', $orderCurrency = 'RUB')
    {
        $order = new self([
            '_orderSum' =>  $orderSum,
            '_orderCurrency' => $orderCurrency,
